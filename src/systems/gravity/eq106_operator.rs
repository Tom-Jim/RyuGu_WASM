...
use crate::components::{ActiveGravityMethod, GravityRuntimeError};
use crate::systems::eq106::{Complex64, Eq106Error};
use bevy::prelude::*;
...
mod tests {
    ...
    fn complex_psi_table_is_certified_on_the_runtime_frequency_rays() {
        ...
        let line = crate::systems::eq106::Eq106ReferenceLine::new(
        ...
        let direct =
            crate::systems::eq106::eq106_kernel_sample(line, source, frequency, 2.0e-10).unwrap();
        let x = frequency * a;
